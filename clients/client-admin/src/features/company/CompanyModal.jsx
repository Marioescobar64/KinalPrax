...
export const CompanyModal = ({ isOpen, onClose, onSave, initialData }) => {
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setFormData({ nombreEmpresa: "", direccion: "", encargado: "", correo: "", telefono: "" });
    }
  }, [initialData, isOpen]);
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      ...
      <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl flex flex-col overflow-hidden max-h-[90vh] border border-gray-100">
        ...
        {/* Inputs del Formulario vinculados al backend Schema */}
        <form onSubmit={handleSubmit} className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="flex-1 p-6 overflow-y-auto space-y-4 bg-white">
            ...
            <div className="space-y-1">
              <label className="block text-xs font-bold text-gray-700 uppercase tracking-wide">Nombre de la Empresa</label>
              <input 
                required 
                maxLength={255}
                type="text" 
            ...
            {/* Dirección */}
            <div className="space-y-1">
              <label className="block text-xs font-bold text-gray-700 uppercase tracking-wide">Dirección Completa</label>
              <input 
                required 
                maxLength={255}
                type="text" 
                ...
                placeholder="Ej. Av. Central Nro 450" 
                className="w-full px-3.5 py-2.5 border border-gray-200 rounded-xl focus:ring-4 focus:ring-[#C00000]/5 focus:border-[#C00000] outline-none transition text-sm text-gray-800" 
              />
            </div>
            ...
            {/* Encargado */}
            <div className="space-y-1">
              <label className="block text-xs font-bold text-gray-700 uppercase tracking-wide">Nombre del Encargado</label>
              <input 
                required 
                maxLength={255}
                type="text" 
            ...
            {/* Sección combinada: Correo y Teléfono */}
          ...
          <div className="px-6 py-3.5 bg-gray-50 border-t border-gray-100 flex gap-3 justify-end">
            ...
            >
              ...
              {initialData ? "Guardar" : "Crear Empresa"}
            </button>
          </div>
        </form>
